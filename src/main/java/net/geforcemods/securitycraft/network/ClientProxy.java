...
import net.geforcemods.securitycraft.renderers.SCPistonTileEntityRenderer;
...
public class ClientProxy implements IProxy {
	...
	public void clientSetup()
	{
		...
		ClientRegistry.bindTileEntitySpecialRenderer(SCPistonTileEntity.class, new SCPistonTileEntityRenderer());
